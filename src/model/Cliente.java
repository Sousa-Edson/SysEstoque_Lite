...
public class Cliente {
    ...
    int cliente_id, sis_cliente, stcliente;
    String cliente_tipo, cliente_nome, cliente_cnpj, cliente_inscricao,
            cliente_descricao, cliente_telefone, cliente_endereco, cliente_no, cliente_cep,
            cliente_complemento, cliente_bairro, cliente_cidade, cliente_observacao,
            cliente_usuario, cliente_registro;
    ...
    public int getSis_cliente() {
        return sis_cliente;
    }

    public void setSis_cliente(int sis_cliente) {
        this.sis_cliente = sis_cliente;
    }

    public int getStcliente() {
        return stcliente;
    }

    public void setStcliente(int stcliente) {
    ...
    public String getCliente_registro() {
        return cliente_registro;
    }

    public void setCliente_registro(String cliente_registro) {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 83 * hash + Objects.hashCode(this.cliente_nome);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(this.cliente_nome, other.cliente_nome);
    }

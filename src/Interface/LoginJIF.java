...
//            menu.PapelParede.requestFocus();
            Principal.jLabelTipoUsuario.setText("Manutenção");
            Principal.jLabelNomeUsuario.setText("Sistema");
            preenche_Empresa_Id();

//            this.dispose();
            Principal.jMenuItem_EscondeMenu.doClick();
...
//                abrePrincipal();
                ...
                if (senha.equals(SenhaDigitada)) {
                    Principal.jLabelTipoUsuario.setText(tipo);
                    Principal.jLabelNomeUsuario.setText(nome);
                    preenche_Empresa_Id();
...
//        Principal.jLabel_NomeEmpresa1.setText(Empresa_Nome_Menu);
        Principal.jLabel_Empresa.setText(Empresa_Id_Menu);
        conex_Empresa.desconecta();
    }

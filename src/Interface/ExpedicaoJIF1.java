 ...
 * @author David
 */
public final class ExpedicaoJIF1 extends javax.swing.JInternalFrame {
...
//    JIF_Movimento_Peq2 obj_Movimento1 = new JIF_Movimento_Peq2();
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Ver Relatorio");
        ...
        jRadioButton2.setText("Ver Nota");
        ...
        jRadioButton3.setText("Ver Expedição");
        ...
        jRadioButton4.setText("Ver Protocolo");
...
//        String texto = "SAIDA";
        preencherTabela(""
                ...
                + "  inner join natureza on id_natureza=naturezaint\n"//// and  nota_situacao!='4-ENVIADO'and nota_situacao!='5-DEVOLVIDO'
                + "  \n"
                + "\n"
                + "  where stnota=1 and stmovimento=1 and stprod =1 and cl.stecft =1 and stunid =1 and stnat =1 and tipo_natureza='SAIDA' "
...
//    }
    ...
    public void atualizarTabela() {
        CorNaLinha();
//        preencherTabela("select nota_data,id_nota,nota.nota_data,id_prod,desc_prod,nota_nota,nota_documento,nota_observacao,\n"
//                + "SUM(qtd_mov) AS qtd_mov,SUM(qtd_prod) as qtd_prod,id_nota,nota_fornecedor,nota_situacao,id_referencia\n"
//                + ",un_prod ,nota_operacao,status_mov,data_mov,nota_hora,nota_data,tipo_prod,nome_prod,edicao_prod,guia,complemento_mov,destino_mov\n"
//                + "From movprodutobase  Inner Join produto on id_prod_ent = sis_prod   inner join nota on id_referencia = nota_mov  \n"
//                + " where nota_operacao='SAIDA' and nota_situacao!='4-ENVIADO' and nota_situacao!='5-DEVOLVIDO' \n"
//                + "and nota_status='ATIVO' and status_mov ='ATIVO'and status_prod ='ATIVO'  \n" // and status_prod ='ATIVO'
//                + " GROUP BY  \n"
//                + "produto.id_prod,produto.desc_prod,nota.id_nota,nota.nota_situacao,\n"
//                + "nota.nota_data,nota.nota_operacao,nota.nota_nota,nota.nota_documento,nota.nota_observacao,movprodutobase.status_mov,\n"
//                + " movprodutobase.data_mov,movprodutobase.complemento_mov,movprodutobase.destino_mov order by  CAST(nota_data as text )asc,id_referencia asc");
//                + "where op_mov='" + texto + "' and nota_situacao!='+4-ENVIADO+' and nota_situacao!='" + texto3 + "'"

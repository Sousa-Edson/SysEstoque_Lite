 ...
 * @author DNA
 */
public class JDialogExpedicaoSaida extends javax.swing.JDialog {
    ...
    public JDialogExpedicaoSaida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//        }
    ...
    private void jButtonEnvAgoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEnvAgoActionPerformed
        ...
        try {
            ...
            Logger.getLogger(JDialogExpedicaoSaida.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        ExpedicaoJIF.jButton1.doClick();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogExpedicaoSaida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogExpedicaoSaida dialog = new JDialogExpedicaoSaida(new javax.swing.JFrame(), true);

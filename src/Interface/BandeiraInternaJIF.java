 ...
 * @author edson
 */
public class BandeiraInternaJIF extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jCheckBoxMenuItem_Modo1 = new javax.swing.JCheckBoxMenuItem();
        jCheckBoxMenuItem_Modo2 = new javax.swing.JCheckBoxMenuItem();
        ...
        jCheckBoxMenuItem_Modo1.setSelected(true);
        jCheckBoxMenuItem_Modo1.setText("Modo 01");
        jCheckBoxMenuItem_Modo1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCheckBoxMenuItem_Modo1ActionPerformed(evt);
            }
        });
        jMenu1.add(jCheckBoxMenuItem_Modo1);

        jCheckBoxMenuItem_Modo2.setText("Modo 02");
        jCheckBoxMenuItem_Modo2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCheckBoxMenuItem_Modo2ActionPerformed(evt);
            }
        });
        jMenu1.add(jCheckBoxMenuItem_Modo2);
        ...
        jCheckBoxMenuItem1.setText("Medio");
        ...
        jCheckBoxMenuItem2.setText("Pequeno");
        ...
        jCheckBoxMenuItem3.setText("Grande");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jCheckBoxMenuItem_Modo1.isSelected()) {
            EventoBuscar2();
        } else {
            EventoBuscar();
        }
    ...
    private void jTextFieldBuscaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldBuscaKeyReleased
        if (evt.getKeyCode() == evt.VK_ENTER) {
           if (jCheckBoxMenuItem_Modo2.isSelected()) {
            EventoBuscar2();
        } else {
            EventoBuscar();
        }
...
//            this.setTitle("Erro inesperado");
    ...
    private void jCheckBoxMenuItem_Modo2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxMenuItem_Modo2ActionPerformed
        if (jCheckBoxMenuItem_Modo2.isSelected()) {
            jCheckBoxMenuItem_Modo1.setSelected(false);
        } else {
        }
    }//GEN-LAST:event_jCheckBoxMenuItem_Modo2ActionPerformed

    private void jCheckBoxMenuItem_Modo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxMenuItem_Modo1ActionPerformed
        if (jCheckBoxMenuItem_Modo1.isSelected()) {
            jCheckBoxMenuItem_Modo2.setSelected(false);
        } else {
        }
    }//GEN-LAST:event_jCheckBoxMenuItem_Modo1ActionPerformed
...
//        jTextFieldBusca.setText("");
    ...
    public void preencherTabela(String Sql) {
        ...
        try {
            ...
            this.setTitle("##     Consulta Bandeira     ##");
        } catch (SQLException ex) {
//            JOptionPane.showMessageDialog(rootPane, "Busque novamente");
            this.setTitle("Consulta Bandeira  Busque novamente");
...
//        jTableListaProduto.getColumnModel().getColumn(4).setResizable(true);
    ...
    private javax.swing.JCheckBoxMenuItem jCheckBoxMenuItem_Modo1;
    private javax.swing.JCheckBoxMenuItem jCheckBoxMenuItem_Modo2;

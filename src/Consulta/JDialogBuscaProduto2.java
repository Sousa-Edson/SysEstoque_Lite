 ...
 * @author David
 */
public class JDialogBuscaProduto2 extends javax.swing.JDialog {
    ...
    public JDialogBuscaProduto2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//        jLabel1.setText(selecao_id);
            if (evt.getClickCount() == 2) {
                try {
                    selecao = (int) jTable_Produto.getValueAt(jTable_Produto.getSelectedRow(), 0);
                    FrameMovimentoComplemento.jTextField_Busca_Produto_Nota.setText(selecao_nome);
                    FrameMovimentoComplemento.jLabelMeuSaldoProduto.setText(SelecaaoSaldo + " / " + SelecaaoUnid);
                    FrameMovimentoComplemento.jLabel_IdProduto.setText("" + selecao);
...
//            JOptionPane.showMessageDialog(rootPane, "" + ex);
    ...
    public void PreencheDadosProduto() {
        ...
        conex.conexao();
        conex.executaSql2("select * from produto inner join unidade on  idunid=id_unidade where id_prod ='" + selecao_id + "' order by sis_prod asc");
        try {
            conex.rs.first();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogBuscaProduto2.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogBuscaProduto2 dialog = new JDialogBuscaProduto2(new javax.swing.JFrame(), true);
